...
class FollowBall(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            ...
            10)
        # self.follow_ball_publisher_ = self.create_publisher(Twist, '/cmd_vel', 10)
    ...
    def timer_callback(self):
        ...
        if self.search_for_ball:
            ...
            if (time.time() - self.lastrcvtime < self.rcv_timeout_secs):
                ...
                print(f"Target Distance: {self.target_dist}, Max Size Thresh: {self.max_size_thresh}")
            ...
            # publish msg if can move
            if self.can_move and msg.data:
                self.can_move = False
