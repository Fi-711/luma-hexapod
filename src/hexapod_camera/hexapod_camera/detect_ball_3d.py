...
class DetectBall3d(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("h_fov",1.05767) # camera h_fov = 60.6 degrees => 1.05767
        self.declare_parameter("ball_radius",0.0677) # ball size
        self.declare_parameter("aspect_ratio",4.0/3.0) # 640 x 480
